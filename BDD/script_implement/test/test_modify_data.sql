...
SELECT modify_georefs(id_georefs => 1, user_georef => '''AMAMAA''', georef_principal => False);

SELECT modify_georefs(id_georefs => 4, user_georef => '''AMAAMA''', footprint => '''POLYGON((50.6373 3.0750,50.6374 3.0750,50.6374 3.0749,50.63 3.07491,50.6373 3.0750))''',
					 epsg => 2154);